...
function DiamondSallReg() {
  ...
  const getDiamondList = () => {
    axios
      .get(`${process.env.REACT_APP_API}/diamond-sall?page=${page}&per_page=1000`)
      .then((res) => {
  ...
  const handleSubmitDiamond = (diamond_data) => {
    ...
    fetch(`${process.env.REACT_APP_API}/diamond-sall`, {
      method: "POST",
